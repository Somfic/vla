...
public class MathNode : Node
{
	...
	{
		[NodeEnumValue("Add", "Arithmetic")]
		Add,

		[NodeEnumValue("Subtract", "Arithmetic")]
		Subtract,

		[NodeEnumValue("Multiply", "Arithmetic")]
		Multiply,

		[NodeEnumValue("Divide", "Arithmetic")]
		Divide,

		[NodeEnumValue("Modulo", "Arithmetic")]
		Modulo,

		[NodeEnumValue("Power", "Functions")]
		Power,

		[NodeEnumValue("Logarithm", "Functions")]
		Logarithm,

		[NodeEnumValue("Square root", "Functions")]
		SquareRoot,

		[NodeEnumValue("Inverse square root", "Functions")]
		InverseSquareRoot,

		[NodeEnumValue("Absolute", "Functions")]
		Absolute,

		[NodeEnumValue("Exponent", "Functions")]
		Exponent,

		[NodeEnumValue("Minimum", "Comparison")]
		Minimum,

		[NodeEnumValue("Maximum", "Comparison")]
		Maximum,

		[NodeEnumValue("Less than", "Comparison")]
		LessThan,

		[NodeEnumValue("Greater than", "Comparison")]
		GreaterThan,

		[NodeEnumValue("Sign", "Comparison")]
		Sign,

		[NodeEnumValue("Compare", "Comparison")]
		Compare,

		[NodeEnumValue("Smooth minimum", "Comparison")]
		SmoothMinimum,

		[NodeEnumValue("Smooth maximum", "Comparison")]
		SmoothMaximum,

		[NodeEnumValue("Round", "Rounding")]
		Round,

		[NodeEnumValue("Floor", "Rounding")]
		Floor,

		[NodeEnumValue("Ceil", "Rounding")]
		Ceil,

		[NodeEnumValue("Truncate", "Rounding")]
		Truncate,

		[NodeEnumValue("Fraction", "Rounding")]
		Fraction,

		[NodeEnumValue("Wrap", "Rounding")]
		Wrap,

		[NodeEnumValue("Snap", "Rounding")]
		Snap,

		[NodeEnumValue("Ping-Pong", "Rounding")]
		PingPong,

		[NodeEnumValue("Sine", "Trigonometry")]
		Sine,

		[NodeEnumValue("Cosine", "Trigonometry")]
		Cosine,

		[NodeEnumValue("Tangent", "Trigonometry")]
		Tangent,

		[NodeEnumValue("Arcsine", "Trigonometry")]
		ArcSine,

		[NodeEnumValue("Arccosine", "Trigonometry")]
		ArcCosine,

		[NodeEnumValue("Arctangent", "Trigonometry")]
		ArcTangent,

		[NodeEnumValue("Arctangent 2", "Trigonometry")]
		ArcTangent2,

		[NodeEnumValue("Hyperbolic sine", "Trigonometry")]
		HyperbolicSine,

		[NodeEnumValue("Hyperbolic cosine", "Trigonometry")]
		HyperbolicCosine,

		[NodeEnumValue("Hyperbolic tangent", "Trigonometry")]
		HyperbolicTangent,

		[NodeEnumValue("To radians", "Conversion")]
		ToRadians,

		[NodeEnumValue("To degrees", "Conversion")]
		ToDegrees
	}
