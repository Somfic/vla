...
//
// 	private readonly ImmutableDictionary<Type, NodeStructure> _nodeStructures =
// 		ImmutableDictionary<Type, NodeStructure>.Empty;
//
// 	private readonly ImmutableDictionary<Type, TypeDefinition> _typeDefinitions =
// 		ImmutableDictionary<Type, TypeDefinition>.Empty;
//
...
// 	}
//
// 	private ImmutableArray<TypeDefinition.LabeledValue> GetPossibleValues(Type type)
// 	{
// 		if (type.IsEnum)
// 			return Enum.GetNames(type)
// 				.Select(x => (value: x, label: EnumExtensions.GetValueNameFromEnum(type, x)))
// 				.Select(x => new TypeDefinition.LabeledValue(Enum.Parse(type, x.value), x.label))
// 				.ToImmutableArray();
//
// 		return ImmutableArray<TypeDefinition.LabeledValue>.Empty;
// 	}
// }