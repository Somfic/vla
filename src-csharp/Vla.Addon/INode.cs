...
public abstract class Node
{
    ...
    /// </summary>
    public ImmutableDictionary<string, string> InputLabels { get; internal set; } = ImmutableDictionary<string, string>.Empty;
    ...
    /// </summary>
	public ImmutableDictionary<string, string> OutputLabels { get; internal set; } = ImmutableDictionary<string, string>.Empty;
